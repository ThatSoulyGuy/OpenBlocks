...
public class ItemDropperMenu extends OpenBlocksContainerMenu {

    private final Container container;

    public ItemDropperMenu(int containerId, Inventory playerInventory) {
        this(containerId, playerInventory, new SimpleContainer(9));
    }

    public ItemDropperMenu(int containerId, Inventory playerInventory, Container container) {
        super(OpenBlocksMenus.ITEM_DROPPER.get(), containerId);
