...
public final class OpenBlocksClient {
    ...
    public static void init() {
        ...
        EntityRendererRegistry.register(OpenBlocksEntities.GLYPH, GlyphEntityRenderer::new);
        ...
        BlockEntityRendererRegistry.register(OpenBlocksBlockEntities.AUTO_ENCHANTMENT_TABLE.get(), AutoEnchantmentTableBlockEntityRenderer::new);
        ...
        BlockEntityRendererRegistry.register(OpenBlocksBlockEntities.CANVAS.get(), CanvasBlockEntityRenderer::new);
    ...
    private static void registerColorHandlers() {
        ...
        ColorHandlerRegistry.registerItemColors(
                (stack, tintIndex) -> {
                    if (tintIndex == 0) {
                        ...
                        if (props != null) {
                            DyeColor dye = props.get(ElevatorBlock.COLOR);
                            if (dye != null) {
                                return ColorMeta.fromDyeColor(dye).getRgb();
                            }
                        }
        ...
        ColorHandlerRegistry.registerItemColors(
                (stack, tintIndex) -> {
                    if (tintIndex == 0) {
                        DyeColor dye = ElevatorRotatingBlock.getItemColor(stack);
                        if (dye != null) {
                            return ColorMeta.fromDyeColor(dye).getRgb();
                        }
                    }
